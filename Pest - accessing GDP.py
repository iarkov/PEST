...
#     try:
#         df = quandl.get("WWDI/"+str(abbv)+"_NY_GDP_MKTP_KN", authtoken="QnBdjmbzJ7NxzD-FKSth",start_date="1998-12-31")
...
#         df = pd.DataFrame(df.values, index=arrays,columns=['GDP'])
...
#     except BaseException:
#         continue
# main_df.to_pickle('GDP.pickle')

df = pd.read_pickle('GDP.pickle')
